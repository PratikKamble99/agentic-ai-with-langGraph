...
from langgraph_backend import chatbot, retrive_all_threads, ingest_pdf, thread_document_metadata
import uuid
...
# give button to upload pdf and index it for the current thread
...
user_query = st.chat_input("Ask about your document or use tools")
